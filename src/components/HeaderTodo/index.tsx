  ...
  return (
    ...
    >
      ...
      <Grid item style={{ width: '100%' }} >
        <Grid container wrap='nowrap' alignItems='flex-end' justifyContent='flex-end' direction={`${innerWidth > 550 ? 'row' : 'column-reverse'}`}>
          <Input
            value={text}
            onChange={(e) => setText(e.target.value)}
            style={{ maxWidth: '350px', width: '100%', marginRight: '35px', marginLeft: '35px', marginTop: innerWidth > 550 ? '0px' : '15px' }}
            placeholder='Add...'
          />
          <Box width='120px'>
            <Button
